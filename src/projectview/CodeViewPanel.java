...
public class CodeViewPanel implements Observer {
	...
	private JTextField[] codeHex = new JTextField[Memory.CODE_MAX / 2], codeDecimal = new JTextField[Memory.CODE_MAX / 2];
	private int previousColor = -1;
	
	public CodeViewPanel(ViewMediator gui, MachineModel model) {
		this.model = model;
